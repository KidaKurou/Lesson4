...
public class DownloadWorker extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_download_worker, container, false);
        ...
        buttonStartDownload.setOnClickListener(v -> {
            ...
            OneTimeWorkRequest downloadRequest = new OneTimeWorkRequest.Builder(DownloadBackground.class).build();
