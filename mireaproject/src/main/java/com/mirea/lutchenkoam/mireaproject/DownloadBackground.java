...
public class DownloadBackground extends Worker {

    public DownloadBackground(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        // Здесь реализуется ваша фоновая задача.
